...
export default function RecursiveTreePage() {
  const project = getAllProjects().find((p) => p.slug === "recursive-tree");
    ...
    <DetailPage title={project.title} tags={project.tags} summary={project.summary} toc={TOC}>
      <section id="overview">
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 24 }}>
          <Image
            src="/project_previews/recursive_trees.png"
            alt="Recursive Tree Visualization"
            width={550}
            height={400}
          />
        </div>
      ...
      <section id="implementation">
        ...
        <p>
          The sketch is implemented in Python using a simple drawing library. A single recursive
          function draws a line segment, computes the end point, and then calls itself for each
          child branch until a minimum length threshold is reached. Parameters like depth, angle,
          and threshold can be adjusted to explore different families of trees. You can find the code <a href="https://github.com/thuthancs/beautiful-math/blob/main/trees/draw_tree.py">here</a>.
          </p>
      </section>
